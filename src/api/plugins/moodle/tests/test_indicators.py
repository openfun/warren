...
async def test_course_daily_mixin_fetch_activities_course_content_not_found(
    ...
    """Test `fetch_activities` raises an exception when content is not found."""
...
async def test_course_daily_mixin_fetch_activities_with_no_modname(
    ...
    """Test fetch_activities with no `modname` returns all course activities."""
    RelationFactory.__session__ = db_session
...
async def test_course_daily_mixin_fetch_activities_with_modname(
    ...
    """Test fetch_activities with modname return activities with `modname` type."""
    RelationFactory.__session__ = db_session
...
async def test_course_daily_views_compute_with_no_modname(
    ...
    """Test CourseDailyViews computing with no modname return daily views for
...
async def test_course_daily_views_compute_with_modname(
    ...
    """Test CourseDailyViews computing with modname returns daily views for
    course activities with modname type.
    """  # noqa: D205
    RelationFactory.__session__ = db_session
...
async def test_course_daily_unique_views_compute_with_no_modname(
    ...
    """Test CourseDailyUniqueViews computing with no modname return daily
    viewers for all course activities.
    """  # noqa: D205
    RelationFactory.__session__ = db_session
...
async def test_course_daily_unique_views_compute_with_modname(
    ...
    """Test CourseDailyUniqueViews computing with modname returns daily viewers
    for course activities with modname type.
    """  # noqa: D205
    RelationFactory.__session__ = db_session
