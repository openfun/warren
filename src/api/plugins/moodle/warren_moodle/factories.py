    ...
    template: dict = {
        ...
        "object": {
            ...
            "definition": {
                ...
                "extensions": {
                    "https://w3id.org/learning-analytics/learning-management-system/external-id": ""  # noqa: E501
                },
            },
        },
        "verb": {
        ...
        "context": {
            ...
            "extensions": {
                "http://lrs.learninglocker.net/define/extensions/info": {
                    ...
                    "event_function": "\\src\\transformer\\events\\mod_url\\course_module_viewed",  # noqa: E501
                }
            },
            "contextActivities": {
                "grouping": [
                    ...
                    },
                    {
                        ...
                        "definition": {
                            ...
                            "name": {"en": "xAPI 101"},
                            "extensions": {
                                "https://w3id.org/learning-analytics/learning-management-system/short-id": "",  # noqa: E501
                                "https://w3id.org/learning-analytics/learning-management-system/external-id": "",  # noqa: E501
                            },
                        },
                    },
