...
class VideoPlayedFactory(BaseXapiStatementFactory):
    """Video played xAPI statement factory."""
...
class VideoCompletedFactory(BaseXapiStatementFactory):
    """Video completed xAPI statement factory."""
    ...
    template: dict = {
        ...
        "result": {
            "extensions": {
                "https://w3id.org/xapi/video/extensions/time": 0.0,
