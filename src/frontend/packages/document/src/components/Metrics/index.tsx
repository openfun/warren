...
export const DownloadsMetric: React.FC<DownloadsMetricProps> = ({
  ...
  const total = useMemo(() => sumDownloads(documentDownloads), [documentDownloads]);
  ...
  const { documentDownloads: comparisonData, isFetching: isComparisonFetching } =
  ...
  const comparison = useMemo(() => sumDownloads(comparisonData), [comparisonData]);
